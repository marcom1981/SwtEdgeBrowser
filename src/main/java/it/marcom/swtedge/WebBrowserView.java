...
abstract class WebBrowserView {
    BrowserView browser;
    Map<Integer, BrowserViewFunction> functions = new HashMap<> ();
    ...
    public class EvaluateViewFunction extends BrowserViewFunction {
        public EvaluateViewFunction (BrowserView browser, String name) {
